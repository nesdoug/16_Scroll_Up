...
; BoxGuy1.vel_x = 0;
;
L075A:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; BoxGuy1.x += BoxGuy1.vel_x;
;
L05C8:	lda     _BoxGuy1+4
	clc
	adc     _BoxGuy1
	sta     _BoxGuy1
	lda     _BoxGuy1+4+1
...
; BoxGuy1.vel_y = 0;
;
L075F:	sta     _BoxGuy1+6
	stx     _BoxGuy1+6+1
;
; BoxGuy1.y += BoxGuy1.vel_y;
;
L060C:	lda     _BoxGuy1+6
	clc
	adc     _BoxGuy1+2
	sta     _BoxGuy1+2
	lda     _BoxGuy1+6+1
...
;
	...
	sec
	sbc     _eject_D
L076A:	sta     _BoxGuy1+3
;
; temp5 = BoxGuy1.y;
;
L062F:	lda     _BoxGuy1+2+1
	sta     _temp5+1
	lda     _BoxGuy1+2
	sta     _temp5
;
...
;
L06B3:	ldy     _coordinates
	lda     _c_map2,y
L077B:	sta     _collision
;
; }
;
	rts
