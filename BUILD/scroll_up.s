...
; BoxGuy1.vel_y = 0;
;
L0764:	sta     _BoxGuy1+6
	stx     _BoxGuy1+6+1
;
; BoxGuy1.y += BoxGuy1.vel_y;
;
L0611:	lda     _BoxGuy1+6
	clc
	adc     _BoxGuy1+2
	sta     _BoxGuy1+2
	lda     _BoxGuy1+6+1
...
;
	...
	sec
	sbc     _eject_D
L076F:	sta     _BoxGuy1+3
;
; temp5 = BoxGuy1.y;
;
L0634:	lda     _BoxGuy1+2
	sta     _temp5
	lda     _BoxGuy1+2+1
	sta     _temp5+1
;
...
;
L06B8:	ldy     _coordinates
	lda     _c_map2,y
L077F:	sta     _collision
;
; }
;
	rts
